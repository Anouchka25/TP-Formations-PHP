...
<br><br>
<label>Adresse postale:</label><textarea rows="2" col="30" name="adressepostale" placeholder="Votre adresse"></textarea>
<br><br>
<label>Code postal:</label><input type="text" pattern="[0-9]{5}" placeholder="Saissisez 5 chiffres maximum" name="cp">
<br><br>
<label>E-mail:</label><input type="email" name="email" placeholder="Votre adresse électronique">
<br><br>
<label>Site:</label><input type="url" name="site" placeholder="Votre page Web">
<br><br>
<label>Téléphone:</label>
<input type="text" name="telephone" pattern="0[6-7][0-9]{8}" placeholder="0658898531" placeholder="Exemple : 0602030405 sans espace ni tirets" >
<br><br>
